...
### model https://arxiv.org/abs/1904.00625
...
class MedicalNet(nn.Module):
    ...
    Segmenation -> Classification 
    
    """
    def __init__(self, path_to_weights, device, **kargs):
        super(MedicalNet, self).__init__()
        self.model = resnet34(**kargs)#sample_input_D=193, sample_input_H=229, sample_input_W=193).to(device)
